      ...
      <div className=' w-full h-[100vh] bg-cover bg-center bg-no-repeat z-50 bg-[url(/images/hero-background.jpg)]'>
        <div className='relative'>
          <div className='flex justify-center items-center flex-col'>
            ...
            <button onClick={handleLogin} className='bg-[#6421ff] rounded px-8 py-3 sm:px-12 sm:py-4 md:px-16 md:py-4 lg:px-32 lg:py-5 hover:bg-[#4617b3] transion duration-100'>
